...
const MAINFRAME = {
  ...
  education: [
    { title: "B.Tech CSE", school: "Lovely Professional University", score: "8.11 CGPA (Dean's List)", date: "2023 - 2027", detail: "Ranked in top 15% of university batch." },
    { title: "Intermediate", school: "Lions English School", score: "84.8%", date: "2022 - 2023", detail: "Physics, Chemistry, Maths." },
    { title: "Matriculation", school: "Lions English School", score: "93.8%", date: "2020 - 2021", detail: "Top tier academic performance." }
  ],
  skills: [
    ...
    { title: "Targeting Systems (CV)", icon: <Eye className="w-5 h-5 text-stark-gold" />, skills: ["Face Recognition", "Vector Search", "FAISS", "UMAP", "Similarity Metrics", "Threshold Calibration"] },
  ...
  projects: [
    { title: "GitaRAG", subtitle: "Extractive RAG System", description: "Engineered a fully extractive RAG architecture eliminating generative hallucination through semantic grounding in 700+ verse embeddings using FAISS L2-normalization.", tags: ["FAISS", "MiniLM", "RAG"], github: "https://github.com/Arpita-2755/GitaRAG", demo: "https://gitarag.streamlit.app", medium: "https://medium.com/@arpitamishra2755", icon: <Database /> },
    { title: "PromptGuard", subtitle: "LLM Robustness", description: "Designed a deterministic prompt-mutation engine detecting behavioral drift and response instability without requiring labeled ground truth.", tags: ["distilgpt2", "HuggingFace", "Python"], github: "https://github.com/Arpita-2755/PromptGuard", demo: "https://promptguard-llm-robustness.streamlit.app", medium: "https://medium.com/@arpitamishra2755", icon: <Shield /> },
    { title: "Slot Recommender", subtitle: "Healthcare NLP", description: "Converted free-text patient queries into healthcare appointment slots with 80%+ intent accuracy using Logistic Regression and TF-IDF.", tags: ["Scikit-learn", "TF-IDF", "NLP"], github: "https://github.com/Arpita-2755", demo: null, medium: "https://medium.com/@arpitamishra2755", icon: <Activity /> },
    { title: "IntelliCampus", subtitle: "AI Smart Attendance", description: "Multi-face real-time recognition pipeline with RetinaFace and FaceNet. Optimized FAISS search for sub-second similarity lookup.", tags: ["RetinaFace", "FaceNet", "Flask"], github: "https://github.com/Arpita-2755/IntelliCampus", demo: null, medium: "https://medium.com/@arpitamishra2755", icon: <Eye /> },
    { title: "RouteMate", subtitle: "Bus Reservation", description: "Full-stack reservation platform with queue-based seat allocation (deque) and managed version-controlled CI/CD workflows.", tags: ["Flask", "MySQL", "System Design"], github: "https://github.com/Arpita-2755", demo: null, medium: "https://medium.com/@arpitamishra2755", icon: <Bus /> },
    { title: "Speech Analyzer", subtitle: "Unsupervised ML", description: "NLP clustering pipeline discovering latent semantic speech patterns via contextual MiniLM embeddings and UMAP reduction.", tags: ["KMeans", "UMAP", "NLP"], github: "https://github.com/Arpita-2755", demo: null, medium: "https://medium.com/@arpitamishra2755", icon: <MessageSquare /> },
    { title: "Face Verify", subtitle: "Deep Learning Biometrics", description: "Siamese-style face verification pipeline with 100% recall via systematic similarity threshold calibration.", tags: ["TensorFlow", "Keras", "FaceNet"], github: "https://github.com/Arpita-2755", demo: null, medium: "https://medium.com/@arpitamishra2755", icon: <Cpu /> }
  ],
  experience: [
    ...
    { role: "Technical Team Member", company: "Coding Blocks (DSO), LPU", date: "2023 - 2024", desc: "Competed in 36-hour ByteBash coding hackathon; coordinated workshops.", link: null }
  ],
  achievements: [
    { title: "Team Leader - SIH 2024", desc: "Led 6-member team to architect 'Aqua Quest' web game for groundwater conservation." },
...
const EHA_KB = [
  ...
  { keywords: ["sih", "hackathon", "aqua", "quest"], response: "In SIH 2024, Arpita was the Team Leader for a 6-member team, building 'Aqua Quest'—an educational game for groundwater conservation." },
  { keywords: ["skill", "python", "stack", "know"], response: "Proficient in Python, C++, Java, and SQL. Specialist in GenAI, RAG, and Computer Vision using TensorFlow and FAISS." },
  { keywords: ["github", "repos", "more"], response: "Arpita has over 20+ active repositories in her GitHub mainframe. You can access it via the Nexus or Archives section." },
  { keywords: ["who", "about", "arpita"], response: "Arpita Mishra is an ML Engineer and Visionary Architect specializing in reliability-focused AI systems. I, Eha, am her primary neural interface." }
];

// --- COMPONENTS ---

const ArcReactor = ({ isDark }: { isDark: boolean }) => (
  <motion.div animate={{ rotate: 360 }} transition={{ duration: 15, repeat: Infinity, ease: "linear" }} className="relative w-48 h-48 flex items-center justify-center mb-10">
...
export default function Home() {
  ...
  const handleEhaChat = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const response = match ? match.response : "Data point not found in primary cache. Arpita's GitHub mainframe contains 20+ other logs.";
  ...
  return (
    <main className={`relative min-h-screen transition-all duration-500 ${isDark ? 'bg-[#020617] text-white' : 'bg-gray-50 text-gray-900'} selection:bg-stark-cyan overflow-x-hidden font-sans`}>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center p-6 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className={`font-mono text-xs md:text-sm opacity-80 leading-relaxed max-w-2xl mx-auto border-l-2 pl-4 py-2 ${isDark ? 'text-stark-cyan border-stark-cyan/30 bg-stark-cyan/5' : 'text-stark-red border-stark-red/30 bg-stark-red/5'}`}>
            ...
            Machine Learning Engineer specializing in retrieval systems and representation learning. Specialist in GenAI and Computer Vision missions.
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-20 items-center">
          ...
          <div className="space-y-10">
            ...
            <div className={`space-y-8 text-xl font-light leading-relaxed ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
              ...
              <p>Inspired by the relentless innovation of the Stark Legacy, I specialize in building **Intelligent Armor for Data**. My core focus is **Retrieval-Augmented Generation (RAG)** and **Computer Vision**, where I bridge the gap between raw data and actionable truth.</p>
      ...
      <section id="specs" className="py-32 px-6 max-w-7xl mx-auto border-t border-white/5">
        <h4 className="text-4xl font-black text-center uppercase mb-24 tracking-tighter leading-none">Armor Specifications</h4>
      ...
      {/* EXPERIENCE */}
      <section className={`py-32 px-6 border-y border-white/5 ${isDark ? 'bg-white/[0.01]' : 'bg-gray-100'}`}>
        <div className="max-w-5xl mx-auto">
          <h4 className="text-4xl font-black uppercase text-center mb-24 tracking-tighter leading-none">Operational History</h4>
      ...
      <section id="missions" className="py-40 px-6 max-w-7xl mx-auto">
        <h4 className="text-4xl font-black text-center uppercase mb-24 tracking-tighter leading-none">Tactical Archives</h4>
      ...
      <section className={`py-40 px-6 border-t border-white/5 ${isDark ? 'bg-white/[0.01]' : 'bg-gray-100'}`}>
        <div className="max-w-6xl mx-auto">
          <h4 className="text-4xl font-black uppercase text-center mb-16 tracking-tighter flex items-center justify-center gap-4"><Trophy className="text-stark-gold" /> Field Commendations</h4>
      ...
      <section className="py-40 px-6 max-w-6xl mx-auto border-t border-white/5 text-center">
        <h4 className="text-4xl font-black uppercase text-center mb-16 tracking-tighter flex items-center justify-center gap-4"><Award className="text-stark-gold" /> System Upgrades</h4>
